...
| 🟡 **2. ระยะเตือนภัย (WARNING)** | **7 - 18 cm** | LED WIFI และ LED NTP กระพริบเป็นจังหวะ | ส่งเสียงปี๊บเป็นจังหวะ ยิ่งใกล้ยิ่งถี่ `map(cm, 7, 18, 70, 300) ms` |
| 🔴 **3. ระยะวิกฤต (DANGER)** | **&le; 6 cm** | LED WIFI และ LED NTP ติดสว่างค้างตลอดเวลา | ส่งเสียงร้องปี๊บค้างยาวต่อเนื่อง |
...
| **บนบอร์ด** | **LED NTP** | **พิน 4 (Active LOW)** | หลอดไฟ LED สีเหลืองบนบอร์ด |
